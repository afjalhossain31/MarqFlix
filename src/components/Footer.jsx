      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-center md:text-left">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            <span className="text-3xl font-black tracking-widest text-white" style={{ fontFamily: "var(--font-display)" }}>
          ...
          <div>
            ...
            <div className="flex flex-col items-center md:items-start gap-4">
              ...
              <a
                href="https://github.com/afjalhossain31/MarqFlix"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                <span className="font-semibold transition-colors group-hover:text-red-500">MarqFlix</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-gray-400 hover:text-white hover:scale-105 transition-all duration-300 font-bold flex items-center"
              >
                TVMaze API
              </a>
            </div>
